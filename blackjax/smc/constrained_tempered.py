...
def build_kernel(
    ...
    def kernel(
        ...
        def tempered_logposterior_fn(position: ArrayLikeTree) -> float:
            ...
            constraint_values = constraint_fn(position) / state.lmbda
            tempered_loglikelihood = loglikelihood_fn(constraint_values)
        ...
        tempered_state = TemperedSMCState(smc_state.particles, smc_state.weights, lmbda)
