...
from .smc import constrained_tempered
from .smc import constrained_adaptive_tempered
...
constrained_adaptive_tempered_smc = generate_top_level_api_from(
    constrained_adaptive_tempered
)
constrained_tempered_smc = generate_top_level_api_from(constrained_tempered)
...
smc_family = [
    ...
    constrained_tempered_smc,
    constrained_adaptive_tempered_smc,
]
